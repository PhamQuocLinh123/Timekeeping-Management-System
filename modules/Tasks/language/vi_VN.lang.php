...
$mod_strings = array(
    ...
    'LBL_MODULE_TITLE' => 'Công việc: Tr.chính',
    ...
    'LBL_DAYS_UNTIL_DUE_TASK' => 'Việc này đã đến hạn',
    'LBL_DAYS_OVERDUE' => 'Việc này đã quá hạn ',
    'LBL_TASK_COMPLETED' => 'Việc này đã hoàn thành',
    'LBL_NONE' => 'Không có',
    'LBL_CONTACT' => 'Liên hệ:',
    ...
    'LBL_LIST_MY_TASKS' => 'Công việc đang mở',
    ...
    'LBL_TASK_INFORMATION' => 'Xem tổng quát', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
