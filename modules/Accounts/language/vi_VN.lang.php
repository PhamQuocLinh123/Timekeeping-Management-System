...
$mod_strings = array(
    ...
    'LBL_ACCOUNT_INFORMATION' => 'Thông tin khách hàng', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    ...
    'MSG_SHOW_DUPLICATES' => 'Bản ghi Khách hàng bạn đang tạo ra có thể là một bản sao của một bản ghi Khách hàng đã tồn tại. Hồ sơ Khách hàng có tên tương tự được liệt kê dưới đây. <br>Nhấp vào tạo Khách hàng để tiếp tục tạo Khách hàng mới này, hoặc chọn một Khách hàng sẵn có liệt kê dưới đây.',
