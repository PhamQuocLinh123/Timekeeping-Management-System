...
$mod_strings = array(
    ...
    'ERR_DELETE_RECORD' => 'Số hồ sơ phải được xác định để xóa bỏ Tiềm năng.',
    ...
    'LBL_CONTACT_INFORMATION' => 'Xem tổng quát', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    'LBL_CONTACT_NAME' => 'Tên tiềm năng:',
    'LBL_CONTACT_OPP_FORM_TITLE' => 'Tiềm năng-Cơ hội:',
    'LBL_CONTACT_ROLE' => 'Vai trò:',
    'LBL_CONTACT' => 'Tiềm năng:',
    ...
    'LBL_CONVERTLEAD_TITLE' => 'Chuyển đổi tiềm năng',
    'LBL_CONVERTLEAD' => 'Chuyển đổi tiềm năng',
    'LBL_CONVERTLEAD_WARNING' => 'Cảnh báo: Trạng thái của Tiềm năng bạn chuyển đổi thành "Đã chuyển đổi". Bản ghi Liên hệ và/hoặc Tài khoản có thể đã được tạo từ Tiềm năng. Nếu bạn muốn tiếp tục chuyển đổi Tiềm năng, hãy nhấp vào Save. Để quay lại Tiềm năng mà không chuyển đổi nó, hãy nhấp vào Hủy.',
    ...
    'LBL_DUPLICATE' => 'Tiềm năng tương tự',
    ...
    'LBL_VCARD' => 'vCard',
    'LBL_IMPORT_VCARDTEXT' => 'Tự động tạo một Tiềm năng mới bằng cách nhập khẩu vCard tập tin hệ thống của bạn.',
    ...
    'LBL_LIST_LEAD_SOURCE_DESCRIPTION' => 'Mô tả nguồn tiềm năng',
    'LBL_LIST_LEAD_SOURCE' => 'Nguồn tiềm năng',
    'LBL_LIST_MY_LEADS' => 'Tiềm năng',
    'LBL_LIST_NAME' => 'Tên',
    ...
    'LBL_MODULE_TITLE' => 'Tiềm năng: Tr.chính',
    'LBL_NAME' => 'Tên:',
    ...
    'LBL_SEARCH_FORM_TITLE' => 'Tìm kiếm tiềm năng',
    'LBL_SELECT_CHECKED_BUTTON_LABEL' => 'Chọn lựa tiềm năng',
    'LBL_SELECT_CHECKED_BUTTON_TITLE' => 'Chọn lựa tiềm năng',
    'LBL_STATE' => 'Tiểu bang hoặc khu vực:',
    'LBL_STATUS_DESCRIPTION' => 'Mô tả trạng thái:',
    'LBL_STATUS' => 'Trạng thái:',
    'LBL_TITLE' => 'Chức vụ:',
    'LNK_IMPORT_VCARD' => 'Tạo tiềm năng từ vCard',
    'LNK_LEAD_LIST' => 'Xem tiềm năng',
    ...
    'NTC_REMOVE_CONFIRMATION' => 'Bạn có muốn loại bỏ Tiềm năng từ Vụ việc này?',
    ...
    'LNK_IMPORT_LEADS' => 'Nhập tiềm năng',
//Convert lead tooltips
    'LBL_MODULE_TIP' => 'Các Module để tạo ra một bản ghi mới trong.',
    'LBL_REQUIRED_TIP' => 'Các module cần thiết phải được tạo ra hoặc được chọn trước khi Tiềm năng có thể được chuyển đổi.',
    'LBL_COPY_TIP' => 'Nếu đã kiểm tra, các trường từ Tiềm năng sẽ được sao chép vào các trường có cùng tên trong các bản ghi vừa tạo.',
    ...
    'LBL_ACTIVITIES_MOVE_HELP' => "Chọn bản ghi để di chuyển các hoạt động của Tiềm năng. Nhiệm vụ, Cuộc gọi, Cuộc họp, Ghi chú và Email sẽ được di chuyển đến các bản ghi đã chọn.",
    'LBL_ACTIVITIES_COPY_HELP' => "Chọn (các) hồ sơ để tạo bản sao các hoạt động của Tiềm năng. Tác vụ mới, Cuộc gọi, Cuộc họp và Ghi chú sẽ được tạo cho mỗi bản ghi đã chọn. Email sẽ liên quan đến (những) bản ghi đã chọn.",
    //For export labels
