...
$mod_strings = array(
    ...
    'LBL_CONTACT_INFORMATION' => 'Xem thông tin Liên hệ', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    ...
    'LNK_IMPORT_CONTACTS' => 'Nhập thông tin Liên hệ',
    ...
    'LBL_AOP_CASE_UPDATES' => 'Cập nhật tình huống',
