...
<input type='text' name='{$fields.name_advanced.name}'
    ...
    maxlength='150'        value='{$value}' title=''  tabindex='-1'      accesskey='9'  >
...
{html_options id='account_type_advanced' name='account_type_advanced[]' options=$fields.account_type_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.account_type_advanced.value}
...
{html_options id='industry_advanced' name='industry_advanced[]' options=$fields.industry_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.industry_advanced.value}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='billing_address_city_advanced'>{sugar_translate label='LBL_BILLING_ADDRESS_CITY' module='Accounts'}</label>
                            </div>
            <div class="form-item">
                                
{if strlen($fields.billing_address_city_advanced.value) <= 0}
{assign var="value" value=$fields.billing_address_city_advanced.default_value }
{else}
{assign var="value" value=$fields.billing_address_city_advanced.value }
{/if}
<input type='text' name='{$fields.billing_address_city_advanced.name}'
    id='{$fields.billing_address_city_advanced.name}' size='30'
    maxlength='100'        value='{$value}' title=''  tabindex='-1'      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='billing_address_state_advanced'>{sugar_translate label='LBL_BILLING_ADDRESS_STATE' module='Accounts'}</label>
                            </div>
            <div class="form-item">
                                
{if strlen($fields.billing_address_state_advanced.value) <= 0}
{assign var="value" value=$fields.billing_address_state_advanced.default_value }
{else}
{assign var="value" value=$fields.billing_address_state_advanced.value }
{/if}
<input type='text' name='{$fields.billing_address_state_advanced.name}'
    id='{$fields.billing_address_state_advanced.name}' size='30'
    maxlength='100'        value='{$value}' title=''  tabindex='-1'      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='billing_address_country_advanced'>{sugar_translate label='LBL_BILLING_ADDRESS_COUNTRY' module='Accounts'}</label>
                            </div>
            <div class="form-item">
                                
{if strlen($fields.billing_address_country_advanced.value) <= 0}
{assign var="value" value=$fields.billing_address_country_advanced.default_value }
{else}
{assign var="value" value=$fields.billing_address_country_advanced.value }
{/if}
<input type='text' name='{$fields.billing_address_country_advanced.name}'
    id='{$fields.billing_address_country_advanced.name}' size='30'
...
<input type='text' name='{$fields.email_advanced.name}'
    id='{$fields.email_advanced.name}' size='30'
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='assigned_user_id_advanced'>{sugar_translate label='LBL_ASSIGNED_TO' module='Accounts'}</label>
                            </div>
            <div class="form-item">
