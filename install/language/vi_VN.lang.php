...
$mod_strings = array(
    ...
    'ERR_CHECKSYS_CALL_TIME' => 'Cho phép thời gian gọi vượt qua tài liệu tham khảo trên (điều này nên được đặt ra trong php.ini)',
    ...
    'LBL_DBCONF_SUITE_DB_USER' => 'Người dùng cơ sở dữ liệu SuiteCRM',
    ...
    'LBL_DBCONF_COLLATION' => 'Đối chiếu',
    'LBL_DBCONF_CHARSET' => 'Ký tự',
    'LBL_DBCONF_ADV_DB_CFG_TITLE' => 'Cấu hình database nâng cao',
    ...
    'LBL_SITECFG_SUITE_UP_DIRECTIONS' => 'Nếu được chọn, Hệ thống sẽ kiểm tra định kỳ cho các phiên bản Cập Nhật của các ứng dụng.',
    'LBL_SITECFG_SUITE_UP' => 'Tự động kiểm tra Cập Nhật?',
    ...
    'LBL_WELCOME' => 'Chào mừng đến với SuiteCRM',
...
                                  Để biết thêm thông tin chi tiết, xin vui lòng tham khảo Hướng dẫn cài đặt.                                ',
    ...
    'LBL_SESSION_ERR_DESCRIPTION' => "SuiteCRM dựa vào PHP session để lưu trữ các thông tin quan trọng trong khi kết nối với máy chủ. Cài đặt PHP của bạn không có thông tin session được cấu hình chính xác.
											<br><br>Một lỗi cấu hình phổ biến là <b>'session.save_path'</b>không được trỏ đến một thư mục hợp lệ. <br>
