...
//e.g. auf Deutsch 'Contacts'=>'Contakten',
    'language_pack_name' => 'Tiếng Việt (Vietnamese)',
    'moduleList' => array(
        'Home' => 'Trang chủ',
...
//prospect list type dom
    'prospect_list_type_dom' => array(
        'default' => 'Mặc định',
        'seed' => 'Hạt giống',
        'exempt_domain' => 'Danh sách loại trừ - bằng tên miền',
        'exempt_address' => 'Danh sách loại trừ - bằng địa chỉ Email',
        'exempt' => 'Danh sách loại trừ - bằng Id',
        'test' => 'Thử nghiệm',
    ),
...
$app_strings = array(
    ...
    'ERR_SEARCH_INVALID_QUERY' => 'Có lỗi xảy ra khi thực hiện tìm kiếm. Cú pháp truy vấn của bạn không hợp lệ.',
    'ERR_SEARCH_NO_RESULTS' => 'Không có kết quả tìm kiếm theo tiêu chí của bạn. Thử mở rộng tìm kiếm.',
    'LBL_SEARCH_PERFORMED_IN' => 'Tìm kiếm thực hiện trong',
    'LBL_EMAIL_CODE' => 'Mã email:',
    'LBL_SEND' => 'Gửi',
    'LBL_LOGOUT' => 'Đăng xuất',
    'LBL_LOGOUT_SUCCESS' => 'Đăng xuất thành công',
    'LBL_TOUR_NEXT' => 'Tới',
    ...
    'LBL_EMAIL_ERROR_PREPEND' => 'Đã có lỗi email:',
    ...
    'LBL_EMAIL_MESSAGE_NO' => 'Tin nhắn số.',
    ...
    'ERR_SQS_NO_MATCH_FIELD' => 'Trường không phù hợp: ',
    ...
    'LBL_CHARSET' => 'UTF-8',
    'LBL_CHARTS' => 'Biểu đồ',
    'LBL_QUICK_CHARTS' => 'Biểu đồ nhanh',
    'LBL_QUICK_HISTORY' => 'Dòng thời gian',
    ...
    'LBL_OPEN_ITEMS' => 'Các hạng mục mở',
    ...
    'LBL_VERIFY' => 'Xác thực',
    'LBL_RESEND' => 'Gửi lại',
    'LBL_RECORD_DOES_NOT_EXIST' => 'Lỗi lấy hồ sơ. Hồ sơ này có thể bị xoá hoặc bạn có thể không được phép xem nó.',
    'LBL_PROFILE' => 'Hồ sơ',
    'LBL_MAILMERGE' => 'Mail Merge',
    'LBL_MASS_UPDATE' => 'Cập nhật hàng loạt',
    'LBL_NO_MASS_UPDATE_FIELDS_AVAILABLE' => 'Không có trường sẵn sàng cho cập nhật hàng loạt',
    ...
    'LBL_OR' => 'Hoặc',
    'LBL_PANEL_OVERVIEW' => 'Thông tin Khách hàng',
    ...
    'LBL_PROJECT_TASKS' => 'Công việc trong dự án',
    'LBL_PROJECTS' => 'Dự án',
    'LBL_QUOTES' => 'Báo giá',
    ...
    'LBL_ACCESSKEY_SELECT_CONTACTS_TITLE' => 'Chọn liên lạc',
    'LBL_ACCESSKEY_SELECT_CONTACTS_LABEL' => 'Chọn liên lạc',
    ...
    'LBL_BASIC_FILTER' => 'Bộ lọc cơ bản',
    ...
    'MSG_EMPTY_LIST_VIEW_NO_RESULTS' => 'Chưa có hồ sơ nào. <item2> hoặc <item3> bây giờ.',
    ...
    'LBL_BULK_ACTION_BUTTON_LABEL' => 'Thực hiện hàng loạt',
    'LBL_BULK_ACTION_BUTTON_LABEL_MOBILE' => 'Thực hiện',
    ...
    'ANNUAL_REVENUE_BY_ACCOUNTS' => 'Doanh thu hàng năm theo khách hàng',
    'PIPELINE_BY_SALES_STAGE' => 'Biểu đồ theo giai đoạn bán hàng',
    'LEADS_BY_SOURCE' => 'Tiềm năng theo nguồn',
    'LEADS_BY_STATUS' => 'Tiềm năng theo trạng thái',
    'ACCOUNT_TYPES_PER_MONTH' => 'Khách hàng mới theo tháng',
    ...
    'ERR_BAD_RESPONSE_FROM_SERVER' => 'Các đáp ứng lỗi từ các máy chủ',
    ...
    'LBL_COLUMN_SELECTOR_DISPLAYED_COLS' => 'HIỂN THỊ',
    'LBL_COLUMN_SELECTOR_HIDDEN_COLS' => 'ẨN',
    'LBL_COLUMN_SELECTOR_CLOSE_BUTTON' => 'Đóng',
    'LBL_COLUMN_SELECTOR_SAVE_BUTTON' => 'Lưu Thay đổi',
...
$app_list_strings['aor_format_options']['m-d-Y'] = 'tháng-ngày-năm';
$app_list_strings['aor_format_options']['d-m-Y'] = 'ngày-tháng-năm';
$app_list_strings['aor_format_options']['Y/m/d'] = 'năm/tháng/ngày';
$app_list_strings['aor_format_options']['m/d/Y'] = 'tháng/ngày/năm';
...
$app_list_strings['pdf_template_type_dom']['Leads'] = 'Tiềm năng';
...
$app_list_strings['map_module_type_list']['Cases'] = 'Tình huống';
$app_list_strings['map_module_type_list']['Leads'] = 'Tiềm năng';
...
$app_list_strings['map_relate_type_list']['Accounts'] = 'Khách hàng';
$app_list_strings['map_relate_type_list']['Contacts'] = 'Liên hệ';
$app_list_strings['map_relate_type_list']['Cases'] = 'Tình huống';
$app_list_strings['map_relate_type_list']['Leads'] = 'Tiềm năng';
...
$app_list_strings['marker_image_list']['administration'] = 'Quản trị';
...
$app_list_strings['marker_image_list']['gourmet'] = 'Dệt may';
...
$app_strings['LBL_SUITE_DASHBOARD'] = 'TỔNG QUAN';
...
$app_list_strings['surveys_question_type']['DateTime'] = 'Ngày giờ';
$app_list_strings['surveys_question_type']['Date'] = 'Ngày';
...
$app_strings['LBL_CLICK_HERE'] = 'Bấm vào đây';
$app_strings['LBL_TO_CONTINUE'] = ' để tiếp tục.';
$app_strings['LBL_OPT_OUT'] = 'Chọn không tham gia';
$app_strings['LBL_INVALID_EMAIL'] = 'Không hợp lệ';
$app_strings['LBL_PRIMARY'] = 'Chính';
$app_strings['LBL_EMAIL_ADDRESS'] = 'Địa chỉ Email';

$app_strings['IMAP_HANDLER_ERROR'] = 'LỖI: {error}; từ khóa là: "{key}".';
$app_strings['IMAP_HANDLER_SUCCESS'] = 'OK: kiểm tra cài đặt đã thay đổi "{key}"';
$app_strings['IMAP_HANDLER_ERROR_INVALID_REQUEST'] = 'Yêu cầu không hợp lệ, dùng giá trị "{var}".';
$app_strings['IMAP_HANDLER_ERROR_UNKNOWN_BY_KEY'] = 'Lỗi không rõ đã xảy ra, phím "{key}" không được lưu.';
...
$app_strings['LBL_INSIGHTS'] = 'Chi tiết';
$app_strings['LBL_CHARTS'] = 'Biểu đồ';
$app_strings['LBL_CHART_NOT_FOUND'] = 'Biểu đồ không tìm thấy';
$app_strings['LBL_NO_DATA'] = 'Không có dữ liệu';
$app_strings['LBL_ERROR_FETCHING_METADATA'] = 'Error occurred while fetching metadata';
$app_strings['LBL_TOTAL'] = 'Tổng cộng';
$app_strings['LBL_ACTIONS'] = 'Hành động';
$app_strings['LBL_SELECT_SUBPANEL_BANNER'] = 'Chọn các subpanel để xem';
$app_strings['LBL_SELECT_ITEM'] = 'Chọn một hạng mục';
$app_strings['LBL_WIDGET_NOT_FOUND'] = 'Widget không tìm thấy';
$app_strings['LBL_BAD_CONFIG'] = 'Cấu hình không đúng';
$app_strings['LBL_CONFIG_BAD_CONTEXT'] = 'Lỗi cấu hình: môi trường không cấu hình đúng';
$app_strings['LBL_CONFIG_NO_CONFIG'] = 'Lỗi cấu hình: thiếu config';
$app_strings['LBL_CONFIG_NO_STATISTICS_KEY'] = 'Lỗi cấu hình: thiếu khoá thống kê';
...
$app_strings['LBL_NONE_OUTSTANDING'] = 'Không có';
$app_strings['LBL_VALIDATION_ERROR_REQUIRED'] = 'Thiếu trường bắt buộc: {{fields.field.label}}';
...
$app_strings['LBL_TYPE_TO_SEARCH'] = 'Gõ vào để tìm...';
$app_strings['LBL_SEARCHING'] = 'đang tìm...';
$app_strings['LBL_NOT_FOUND'] = 'Không tìm thấy.';
$app_strings['LBL_SEARCH_ERROR'] = 'Lỗi tìm kiếm.';
$app_strings['LBL_FOUND'] = 'Đã tìm thấy';
...
$app_strings['LBL_OPEN_CASES_COUNT'] = 'Trường hợp chưa đóng';
...
$app_strings['LBL_DEFAULT_TOTAL'] = 'Tổng cộng';
$app_strings['AOS_Contracts'] = 'Hợp đồng';
$app_strings['AOS_Quotes'] = 'Báo giá';
$app_strings['AOS_Invoices'] = 'Hóa đơn';
$app_strings['LBL_PHOTO'] = 'Hình ảnh';
$app_strings['LBL_CASE_UPDATES'] = 'Cập nhật trường hợp';
...
$app_strings['LBL_CREATE'] = 'Tạo';
$app_strings['LBL_SAVED_FILTER_SAVED'] = 'Đã lưu thành công bộ lọc';
...
$app_strings['LBL_OPERATOR'] = 'Toán tử';
$app_strings['LBL_START'] = 'Bắt đầu';
$app_strings['LBL_END'] = 'Kết thúc';
$app_strings['LBL_LINE_ITEMS_FIELD_CONFIG'] = 'Bad config';


$app_strings['LBL_ACTION_SUCCESS'] = 'Action successful';

$app_strings['LBL_YES'] = 'Đồng ý';
$app_strings['LBL_NO'] = 'Không';

$app_list_strings['sort_order'] = [];
$app_list_strings['sort_order']['asc'] = 'tăng dần';
$app_list_strings['sort_order']['desc'] = 'giảm dần';

// Labels used by subpanel unlink relationship process
$app_strings['LBL_LINK'] = 'Liên kết';
...
$app_strings['LBL_LINK_RELATIONSHIP_SUCCESS'] = 'Quan hệ đã kết nối thành công.';
$app_strings['LBL_LINK_RELATIONSHIP_FAILED'] = 'There was an error linking this Relationship.';
$app_strings['LBL_MODULE_NOT_FOUND'] = 'Không tìm thấy module.';
$app_strings['LBL_RECORD_NOT_FOUND'] = 'Không thể tải dữ liệu';
$app_strings['LBL_RELATIONSHIP_LOAD_ERROR'] = 'Không thể tải mối quan hệ';
$app_strings['LBL_NOT_LINKED'] = 'Unable to unlink. Records are not linked';
$app_strings['LBL_ACCESS_DENIED'] = 'Truy cập bị từ chối';
